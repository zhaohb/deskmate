...
- Extract SCREEN tasks from the on-screen evidence ONLY when you are **>90% confident the task is owned by ME**, and exactly one of these holds: (a) a `TODO:` / `FIXME:` note or checklist item **in my own file or notes** (NOT code/issues I'm merely reading in a browser or repo); (b) a chat message **directed at me** — it @-mentions me or addresses me with "you / 你 / 您" and asks me to do something; (c) a checklist item explicitly **assigned to me**. DROP everything else: page titles, article text, menu labels, code being read, generic UI text, deadlines with no owner, and — critically — messages asking **someone else** to do something (e.g. a group message "请更新文档" sent to another person is NOT my todo). If you are not >90% sure it is my personal task, DROP it. Tag kept items `source: screen:<app>`.
