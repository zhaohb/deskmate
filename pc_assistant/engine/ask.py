...
ASK_TOOLS = [
    ...
    },
    {
        ...
        "function": {
            "name": "list_meetings",
            "description": (
                "List VIDEO CALLS detected by pc_assistant (Teams, Zoom, Google Meet, "
...
def _execute_tool(name: str, arguments: dict[str, Any], api_base: str) -> str:
    """Execute a tool call against the local pc_assistant API."""
    try:
...
def run_ask(
    ...
    *,
    ...
    system_prompt = (
        "You are pc_assistant — a local AI that answers questions about the user's "
