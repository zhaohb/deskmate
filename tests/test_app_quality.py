...
def _load_agent_module() -> ModuleType:
    # agent.py is now a real package module (deskmate.apps.agent). Import it
    # directly; keep the legacy bare ``agent`` alias for callers that look it
    # up by that name via sys.modules.
